...
class MovieTestCase(unittest.TestCase):
    ...
    def test_post_actors(self):
        ...
        res = self.client().post('/actors', json=self.new_actor, headers={'Authorization': 'Bearer ' + self.executive_producer})
        data = json.loads(res.data)
    ...
    def test_422_create_movie_with_missing_data_fields(self):
        ...
        res = self.client().post('/actors', json=self.new_movie, headers={'Authorization': 'Bearer ' + self.executive_producer})
        data = json.loads(res.data)
    ...
    def test_update_movie(self):
        ...
        res = self.client().patch('/movies/'+ str(id), 
                                json=self.new_info,
                                headers={'Authorization': 'Bearer ' + self.executive_producer
                                         })
        data = json.loads(res.data)
